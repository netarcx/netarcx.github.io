...
<head>
    ...
    <link rel="stylesheet" href="css/wizard.css?ae5e138">
    <script type="text/javascript" src="../js/jquery-1.8.3.min.js?ae5e138"></script>
    <script type="text/javascript" src="js/tips.js?ae5e138"></script>
    <script type="text/javascript" src="js/setup.js?ae5e138"></script>
</head>
<body>
    <div id="wizard">
        <div id="header">
